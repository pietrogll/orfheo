...
describe 'Services Suggest' do
  ...
  describe 'suggest_event_names' do
    ...
    it 'suggets event names depending on initial character input' do
      ...
      expect(suggestions).to eq [
        { text: 'otter_event_name', id: otter_event_id, profile_id: profile_id, call_id: call_id,
          program_id: program_id }, { text: 'other_event_name', id: other_event_id, profile_id: profile_id, call_id: call_id }
      ]
    end
  end
end
