...
describe 'Services Search' do
  ...
  let(:activity_saved) do
    {
      ...
      dateTime: [
        { date: '2016-10-15', time: %w[1476518400000 1476532800000] },
        { date: '2016-10-15', time: %w[1476543600000 1476565200000] },
        { date: '2016-10-16', time: %w[1476604800000 1476615600000] }
      ],
      permanent: 'false'
    }
  end

  let(:otter_activity_saved) do
    {
      ...
      program_id: program_id,
      dateTime: [
        { date: '2016-10-16', time: %w[1476604800000 1476610000000] }
      ],
      permanent: 'false'
    }
  end

  let(:other_activity_saved) do
    {
  ...
  describe 'get_program_suggestions' do
    ...
    it 'suggets mutliple tags' do
      ...
      expect(suggestions).to include(hash_including({ type: 'title', text: 'my_title' }),
                                     hash_including({ type: 'name', text: 'my_space_name' }))
    end
