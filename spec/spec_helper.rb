...
ENV['RACK_ENV'] = 'test'
ENV['MONGOLAB_URI'] = 'mongodb://localhost:27017/cg_test'

require_relative './support/db_tools'
require_relative './shared_definitions'
...
RSpec.configure do |config|
  ...
  # Removed redundant before(:each) cleaning here, as it's handled in rails_helper.rb
  # Removed after(:all) drop_database to avoid race conditions between spec files
